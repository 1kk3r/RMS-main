...
const navigation = [
  ...
  <div className='relative group'>
    ...
    <span className="absolute left-0 top-full mt-2 w-max opacity-0 group-hover:opacity-100 transition-opacity bg-gray-800 text-white text-xs rounded py-1 px-2">Tareas</span>
  </div>
    ), href: '/tareas'
   },
  {  
    name: (
        <div className='relative group'>
          ...
          <span className="absolute left-0 top-full mt-2 w-max opacity-0 group-hover:opacity-100 transition-opacity bg-gray-800 text-white text-xs rounded py-1 px-2">Inventario</span>
        </div>
        ), href: '/inventario' },
  {
    name: (
      <div className="relative group">
        ...
        <span className="absolute left-0 top-full mt-2 w-max opacity-0 group-hover:opacity-100 transition-opacity bg-gray-800 text-white text-xs rounded py-1 px-2">
          E-commerce
        </span>
      </div>
    ),
  ...
  { 
    name:( 
      <div className='relative group'>
        ...
        <span className="absolute left-0 top-full mt-2 w-max opacity-0 group-hover:opacity-100 transition-opacity bg-gray-800 text-white text-xs rounded py-1 px-2">Mapa</span>   
      </div>
    ),
    href: '/mapa' 
  },
...
export default function Homepage() {
  ...
  const [currentPage, setCurrentPage] = useState('home'); //e-commerce, tareas, inventario, mapa
  ...
  //Si no esta logeado, muestra un formularion de login
  if (isLoggedIn == false){
    return (
      <div>
  ...
  //Si esta logeado, muestra el dashboard
  else {
    return(
      <div>
